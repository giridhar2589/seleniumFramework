...
public class AssetManagementAssetTypesMand_test extends TestBase {
	...
	// Checks for the mandatory field validation on asset types module

		@Test
		public void assetTypeAddMand() throws Exception {
			Thread.sleep(2000);
			AssetManagementAssetTypesMandatory_pageObj.addAssetTypeMand();
			Thread.sleep(1000);
			SoftAssertobj.assertTrue(AssetManagementAssetTypesMandatory_pageObj.assetTypeCreatedMand(),
					"asset types mandatory field validation is not present");
			Thread.sleep(1000);
			AssetManagementAssetTypesMandatory_pageObj.clkOk();
			Thread.sleep(1000);
