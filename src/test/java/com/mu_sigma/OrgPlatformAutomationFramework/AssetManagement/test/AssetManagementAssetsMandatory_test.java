...
public class AssetManagementAssetsMandatory_test extends TestBase {
	...
	@Test
	public void assetAddMand() throws Exception {
		Thread.sleep(5000);
		AssetManagementAssetsMandatory_pageObj.addAssetMand();
		Thread.sleep(500);
		SoftAssertobj.assertTrue(AssetManagementAssetsMandatory_pageObj.assetCreatedMand(),
				"assets mandatory field validation is not present");
		Thread.sleep(500);
		AssetManagementAssetsMandatory_pageObj.clkOk();
