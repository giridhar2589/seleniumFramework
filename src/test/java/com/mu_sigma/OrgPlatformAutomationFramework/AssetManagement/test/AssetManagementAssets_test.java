...
public class AssetManagementAssets_test extends TestBase{
	...
	// Cannot Create a asset Duplicate

		@DataProvider(name = "assetData")
		public String[][] getassetData() {
			String[][] assetData = getData("assetManagement.xlsx", "assetname");
			return assetData;
		}

		@Test(priority = 2, dataProvider = "assetData")
		public void assetDuplicateCantCreate(String asstname, String runmode) throws Exception {
			Thread.sleep(1000);
			AssetManagementAssets_pageObj.addAsset(asstname);
			Thread.sleep(1000);
			//SoftAssertobj.assertTrue(AssetManagementAssets_pageObj.assetCreated(), "asset has not been created");
			SoftAssertobj.assertAll();
			AssetManagementAssets_pageObj.clkOk();
