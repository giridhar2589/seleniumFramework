...
public class AssetManagementLevelMandatory_test extends TestBase {
	...
	// Checks for the mandatory field validation on level module

		@Test
		public void levelAddMand() throws Exception {
			Thread.sleep(2000);
			AssetManagementLevelMandatory_pageObj.addLevelMand();
			Thread.sleep(1000);
			SoftAssertobj.assertTrue(AssetManagementLevelMandatory_pageObj.assetLevelCreatedMand(),
					"Level mandatory field validation is not present");
			Thread.sleep(1000);
			AssetManagementLevelMandatory_pageObj.clkOk();
			Thread.sleep(1000);
