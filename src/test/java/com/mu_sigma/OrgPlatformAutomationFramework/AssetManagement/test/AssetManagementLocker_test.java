...
public class AssetManagementLocker_test extends TestBase {
	...
	// Check for creation of duplicate locker

		@DataProvider(name = "lockerData")
		public String[][] getlockerData() {
			String[][] lockerData = getData("assetManagement.xlsx", "lockernum");
			return lockerData;
		}

		@Test(dataProvider = "lockerData")
		public void lockerAdd(String lockernum, String runmode) throws Exception {
			Thread.sleep(2000);
			AssetManagementLocker_pageObj.addLocker(lockernum);
			Thread.sleep(2000);
			AssetManagementLocker_pageObj.clkOk();
