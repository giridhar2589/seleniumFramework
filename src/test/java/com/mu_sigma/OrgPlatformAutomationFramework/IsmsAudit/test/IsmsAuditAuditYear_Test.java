...
public class IsmsAuditAuditYear_Test extends TestBase{
	...
	/*
	 * Adds the audit years for which the audit findings will be reported by getting the inputs from excel sheet
	 */
	@DataProvider(name = "auditYearData")
	public String[][] getauditYearData() {
		String[][] auditYearData = getData("ismsAudit.xlsx","audityear");
		return auditYearData;
	}
	
	@Test(dataProvider="auditYearData")
	public void auditYear(String yearaudit,String runmode) throws Exception {
		//Thread.sleep(1000);
		Thread.sleep(1000);
		IsmsAuditAuditYear_pageObj.selectAuditYear(yearaudit);
		Thread.sleep(1000);
		assert(IsmsAuditAuditYear_pageObj.auditYearAdded()):"Audit year has not been added";
		Thread.sleep(500);
	}
	@AfterClass
