...
public class IsmsAuditClosed_Test extends TestBase{
	...
	/*
	 * Verifying the first level closure and final closure functionalities
	 */
	
	@DataProvider(name = "auditCloseData")
	public String[][] getauditCloseData() {
		String[][] auditCloseData = getData("ismsAudit.xlsx","close");
		return auditCloseData;
	}
	
	@Test(priority=5, dataProvider="auditCloseData")
	public void closedAudit(String reviewremark,String runmode) throws Exception {
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		IsmsAuditClosed_pageObj.closeAudit(reviewremark);
		Thread.sleep(1000);
