...
public class IsmsAuditDepartment_Test extends TestBase {
	 ...
	 */
	@Test
	public void auditDepartment() throws Exception {
		Thread.sleep(500);
		IsmsAuditDepartment_pageObj.navigateDepatment();
		Thread.sleep(500);
		IsmsAuditDepartment_pageObj.addDepartment();
		Thread.sleep(500);
		assert(IsmsAuditDepartment_pageObj.deptCreated()):"Department has not been created";
	}
	@AfterClass
