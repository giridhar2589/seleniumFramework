...
public class IsmsAuditOpenMandatory_Test extends TestBase {
	...
	/*
	 * Verifying the mandatory field validation for audit finding closure functionality 
	 */
	@Test(priority=4)
	public void auditOpenMand() throws Exception {
		Thread.sleep(500);
		IsmsAuditOpenMandatory_pageObj.navigateOpenMand();
		Thread.sleep(500);
		assert(IsmsAuditOpenMandatory_pageObj.mandatoryPopup()):"Alert for mandatory fields is not displyed";
		Thread.sleep(500);
		IsmsAuditOpenMandatory_pageObj.clickOk();
		Thread.sleep(500);
	}
