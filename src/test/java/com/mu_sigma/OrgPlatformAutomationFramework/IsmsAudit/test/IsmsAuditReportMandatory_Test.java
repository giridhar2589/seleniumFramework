...
public class IsmsAuditReportMandatory_Test extends TestBase {
	...
	/*
	 * Verifying the mandatory fields validation for reporting a audit finding 
	 */
	
	@Test
	public void auditReportMand() throws Exception {
		Thread.sleep(500);
		IsmsAuditReportMandatory_pageObj.navigateReportMand();
		Thread.sleep(500);
		//assert(IsmsAuditReportMandatory_pageObj.mandatoryPopup()):"Alert for mandatory fields is not displyed";
		Thread.sleep(500);
		//IsmsAuditReportMandatory_pageObj.clickOk();
		Thread.sleep(500);
	}
	@AfterClass
