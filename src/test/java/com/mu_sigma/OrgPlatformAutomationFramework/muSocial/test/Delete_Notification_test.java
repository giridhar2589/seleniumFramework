...
public class Delete_Notification_test  extends TestBase {
	...
	public void Delete_Notification()throws InterruptedException{
		muSocialObj.Delete_Notification();
		asert.assertEquals(muSocialObj.NotificationDelSuccessfulmessage(), "Notification has been deleted successfully");
		asert.assertAll();
	}
    @Test(priority=6)
